...
exports.run = async (client, message, args) => {
 ...
 let Booster = client.guilds.cache.get(ayarlar.server_id).roles.cache.get(app.Kayıt_Roller.Booster)
              ...
              Approval.roles.remove(app.Kayıt_Roller.Kayıtsız);
               Approval.roles.add(app.Kayıt_Roller.Kız);
...
exports.help = {
  ...
  usage: ayarlar.prefix+"kız @Approval/"+ayarlar.bot_owner[0]+" Memo 18"
};
/* BU ALT YAPI APPROVAL TARAFINDAN HAZIRLANMIİŞTIR */